...
Contributions to Psion are very welcome, but we ask that you read this document
before submitting a PR.

:::note

This document applies to the [Psion][] repository.
...
- **Backwards compatibility** - Will your change break existing Psion files? It
...
- **Go** - Psion is written in [Go][]. We always support the latest two major Go
  versions, so make sure your version is recent enough.
- **Node.js** - [Node.js][] is used to host Psion's documentation server and is
...
To run Psion with working changes, you can use `go run main.go overlay`.

### Updating documentation

Psion uses [Docusaurus][] to host a documentation server. The code for this is
located in the Psion repository. This can be setup and run locally by using
...
future. Existing tests may also need updating if you have changed Psion's
behavior.
...
[Psion]: https://github.com/retr0h/psion
[Go]: https://go.dev
